...
```{r, echo = TRUE}
#Note: This function or data set name (in this case, data set) may occur in other packages so here I am using the "::" to say I specifically want the data 'CO2' from {datasets}. 
